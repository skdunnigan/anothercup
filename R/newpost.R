# all of this comes from Thomas Mock's post 
# here: https://themockup.blog/posts/2022-11-08-use-r-to-generate-a-quarto-blogpost/#all-together



# install.packages(c('stringr', 'glue', 'fs', 'cli', 'yesno'))

library(stringr) # easy string manipulation
library(glue)    # easy adding of string together
library(fs)      # easy file manipulation
library(cli)     # easy and beautiful warnings/messages
